...
// Psalms singular/plural aliases for LSG (JSON uses Psaume; UI may use Psaumes).
BIBLE_NUM_MAP[normalizeStr('Psaume')] = BIBLE_NUM_MAP[normalizeStr('Psalms')];
BIBLE_NUM_MAP[normalizeStr('Psaumes')] = BIBLE_NUM_MAP[normalizeStr('Psalms')];
FR_TO_EN_BOOK[normalizeStr('Psaume')] = 'Psalms';
FR_TO_EN_BOOK[normalizeStr('Psaumes')] = 'Psalms';
